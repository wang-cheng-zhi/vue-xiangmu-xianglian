  ...
  <div id="out">
    ...
    <section>
      ...
      <div class="Index-list">
        <ul class="Index-ul">
            <router-link to=`/Detail${product._id}` tag="li" class="Index-li" v-for="product in products" :key="product._id">
              ...
              <div class="Index-price">
                <div class="Index-xinprice">￥{{product.price}}元</div>
                <div class="Index-jiuprice">￥{{product.price}}元</div>
              </div>
            </router-link>

  ...
  <div>
    ...
    <section>
      <van-swipe :autoplay="3000" indicator-color="white" class="van-swipe">
        <van-swipe-item><img :src="serverUrl+detail.coverImg"/></van-swipe-item>
        <van-swipe-item><img :src="serverUrl+detail.coverImg"/></van-swipe-item>
        <van-swipe-item><img :src="serverUrl+detail.coverImg"/></van-swipe-item>
        <van-swipe-item><img :src="serverUrl+detail.coverImg"/></van-swipe-item>
      </van-swipe>
      ...
      <div class="detail-color"><span class="detail-color-size">库存</span><div class="detail-color-fenlei">{{detail.quantity}}</div></div>
      ...
      <div class="detail-zhan">
        ...
        <div v-show="tuwen" class="TuwenDetail">
          <img :src="serverUrl+detail.coverImg"/>
          <img :src="serverUrl+detail.coverImg"/>
          <img :src="serverUrl+detail.coverImg"/>
        </div>

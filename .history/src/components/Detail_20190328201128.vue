    ...
    <section>
      ...
      <div class="detail-zhan">
        <div class="detail-zhanshi">
          <div @click="ToTuwenDetail()">图文详情</div>
          <div @click="ToPingjia()">评价</div>
        </div>
...
.detail-zhanshi{background: #ffffff;margin-top: 0.3rem;font-size: 0.8rem;height: 1.4rem;line-height: 1.4rem;margin-bottom: 5rem}
.detail-zhanshi  div{width: 50%;color: #000000;float: left;line-height: 1.4rem;text-align: center;margin-bottom: 5rem;}
